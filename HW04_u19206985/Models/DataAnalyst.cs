...
namespace HW04_u19206985.Models
{
    public class DataAnalyst : Jobs
    {
        ...
        public DataAnalyst(string name, string location, string timeframe, string summary, string reporting, string duration) : base (name, location)
        {
